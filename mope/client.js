...
if (KTestingModeON) {
  ...
  reg = "LOCAL";
  addServerDef("LOCAL", "localhost", reg);
...
Animal.prototype.readCustomData_onUpdate = function(msg) {
 ...
 // console.log("angle2: " + lookAng);
  ...
  var aniFlags = msg.readUInt8();
  this.curBiome = 0;
  if(aniFlags == 1){this.curBiome = 1} else if(aniFlags == 2){this.curBiome = 2};
  this.flag_lowWat = aniFlags == 3;
  this.flag_inHomeBiome = aniFlags == 4;
  this.flag_underWater = aniFlags == 5;
  this.flag_eff_invincible = aniFlags == 6;
  this.flag_usingAbility = aniFlags == 7;
  this.flag_tailBitten = aniFlags == 8;
  this.flag_eff_stunned = aniFlags == 9;
  this.flag_iceSliding = aniFlags == 10;
  this.flag_eff_frozen = aniFlags == 11;
  this.flag_eff_onFire = aniFlags == 12;
  this.flag_eff_healing = aniFlags == 13
  this.flag_eff_poison = aniFlags == 14
  this.flag_constricted = aniFlags == 15
  this.flag_webStuck = aniFlags == 16
  this.flag_stealth = aniFlags == 17
  this.flag_eff_bleeding = aniFlags == 18;
  this.flag_flying = aniFlags == 19;
  this.flag_isGrabbed = aniFlags == 20;
  this.flag_eff_aniInClaws = aniFlags == 21;
  this.flag_eff_stunk = aniFlags == 22;
  this.flag_cold = aniFlags == 23;
  this.flag_inWater = aniFlags == 24;
  this.flag_inLava = aniFlags == 25;
  this.flag_canClimbHill = aniFlags == 26;
  this.flag_isDevMode = aniFlags == 27;
  this.flag_eff_slimed = aniFlags == 28;
  this.flag_eff_wobbling = aniFlags == 29;
  this.flag_eff_hot = aniFlags == 30;
